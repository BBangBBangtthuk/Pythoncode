...
def get_file_list(folder_path = r'C:\Users\chohs\BMS\아이오닉5\01241227999\01241227999\2023-03' , file_extension='.csv'):
...
def process_files_combined(file_lists, folder_path, save_path):
    for file in tqdm(file_lists):
        ...
        if 'altitude' in df.columns:
            ...
            data_save = df[['time', 'batt_coolant_inlet_temp','batt_internal_temp','batt_pw','cell_volt_list','mod_temp_list','ext_temp','chrg_cable_conn','soc','pack_current', 'pack_volt','speed', 'acceleration', 'soh', 'altitude', 'Power_IV'
]].copy()
        else:
            # merge selected columns into a single DataFrame
            data_save = df[['time', 'batt_coolant_inlet_temp','batt_internal_temp','batt_pw','cell_volt_list','mod_temp_list','ext_temp','chrg_cable_conn','soc','pack_current', 'pack_volt','speed', 'acceleration', 'soh',  'Power_IV'
]].copy()
        ...
        folder_path = r'C:\Users\chohs\BMS\아이오닉5\01241227999\01241227999\2023-03'
